...
%% set parameters
clc;clear all;
addpath('./NoiseAttenuation/diffusion_model/data/');
addpath('./NoiseAttenuation/diffusion_model/func/');
...
% You should replace the anaconda environment name in ./NoiseAttenuation/diffusion_model/func/diffusion_model.m 
tic;
...
%% delete cache files
delete('./NoiseAttenuation/diffusion_model/diffusion_model/t_seq.mat');
